...
export default function Dashboard({ navigation, route }) {
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View>
        <Pressable style={styles.button} onPress={() => navigation.navigate('Available Deliveries')}>
          <Text style={styles.text}>SEE ALL DELIVERIES</Text>
        </Pressable>
      </View>
      <View style={styles.separator} />
      <View>
        <Pressable style={styles.button} onPress={() => navigation.navigate('Deliveries To Pick')}>
